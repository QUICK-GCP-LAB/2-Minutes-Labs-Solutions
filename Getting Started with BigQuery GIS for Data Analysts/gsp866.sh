...
# Step 1: Running First BigQuery Query
echo "${YELLOW}${BOLD}Running First BigQuery Query${RESET}"
bq query --use_legacy_sql=false \
'SELECT * FROM `bigquery-public-data.new_york_citibike.citibike_stations` LIMIT 10'

# Step 2: Running Second BigQuery Query
echo "${BLUE}${BOLD}Running Second BigQuery Query${RESET}"
bq query --use_legacy_sql=false \
