...
echo "${BOLD}${MAGENTA}Creating BigQuery dataset 'work_day'${RESET}"
bq mk work_day

# Step 4: Create a table in BigQuery using the schema
echo "${BOLD}${CYAN}Creating table 'employee' in dataset 'work_day'${RESET}"
