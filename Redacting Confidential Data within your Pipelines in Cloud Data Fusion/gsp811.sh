...
# Step 4: Create a JSON file for the inspect template
echo "${MAGENTA}${BOLD}Creating JSON file for the inspect template...${RESET}"
...
# Step 5: Send a POST request to create an inspect template
echo "${CYAN}${BOLD}Creating an inspect template in Google DLP...${RESET}"
curl -X POST \
