...
echo "${BOLD}${CYAN}Getting Project ID & User ID${RESET}"
echo
get_value() {
...
echo "${BOLD}${GREEN}Adding View Access to Dataset${RESET}"
jq ".access += [{
  \"view\": {
...
echo "${BOLD}${YELLOW}Creating IAM Policy File for authorized_view${RESET}"
cat <<EOF > policy.json
{
  "bindings": [
    {
